  ...
  return (
    <section className="py-10 min-h-screen bg-[#F6EACB] flex flex-col justify-center">
      <div className="text-center mb-5">
        <h2 className="text-4xl font-bold text-center mb-5">Learn New Skills</h2>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <h3 className="text-3xl text-gray-800">Learn Anything</h3>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <h3 className="text-3xl text-gray-800">Large Collection</h3>
          <p className="mt-4 text-gray-600">
            Lorem ipsum dolor sit amet, consetetur sadi ps cinelitr, sed diam nonumy eirtem Lorem ipsum dolor sit amet, consetetur.
          </p>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full">
            <i className="fas fa-certificate text-gray-600 text-2xl"></i>
          </div>
          <h3 className="text-3xl text-gray-800">Certified Instructors</h3>
          <p className="mt-4 text-gray-600">
            Lorem ipsum dolor sit amet, consetetur sadi ps cinelitr, sed diam nonumy eirtem Lorem ipsum dolor sit amet, consetetur.
          </p>
        </div>
